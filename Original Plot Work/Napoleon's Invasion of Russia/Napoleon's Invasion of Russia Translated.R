...
text(1575, 575, expression("Distance in leagues, common in France (Map by Mr. Fezensac)"), family = "Map", cex = .85, col = "#383227")
...
text(770, 736, "the temperature, in degrees Réaumur, below zero", family = "Map", cex = 2, col = "#383227")
