...
#Graph Text
text(310, 870, expression("-33.3"^"o"*"C "*"(-27.9"^"o"*"F)"), family = "serif", cex = 1.35, col = "#383227")
text(550, 885, expression("-37.5"^"o"*"C "*"(-35.5"^"o"*"F)"), family = "serif", cex = 1.35, col = "#383227")
text(685, 863, expression("-30.1"^"o"*"C "*"(-22.2"^"o"*"F)"), family = "serif", cex = 1.35, col = "#383227")
text(785, 848, expression("-25.4"^"o"*"C "*"(-13.7"^"o"*"F)"), family = "serif", cex = 1.35, col = "#383227")
text(868, 782, expression("-13.4"^"o"*"C "*"(7.9"^"o"*"F)"), family = "serif", cex = 1.35, col = "#383227")
text(1230, 857, expression("-26.4"^"o"*"C "*"(-15.5"^"o"*"F)"), family = "serif", cex = 1.35, col = "#383227")
text(1425, 815, expression("-12.4"^"o"*"C "*"(9.7"^"o"*"F)"), family = "serif", cex = 1.35, col = "#383227")
text(1775, 780, expression("Rainy 30"^"o"*"C (86"^"o"*"F)"), family = "serif", cex = 1.35, col = "#383227")
