...
town$Area <- town$Area %>%
  factor(levels = c("Paris", "French Cities", "TFrench Cities", "New York City", "Rural France"))
...
png(here::here("Original Plot Work", "1906 - 1913 Tuberculosis Mortality Country&Town", "Tuberculosis Mortality for Countries and Towns-1906-1913 translated.png"),width=1000,height=700)
