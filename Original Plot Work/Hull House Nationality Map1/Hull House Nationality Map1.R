...
polygon(c(800, 755, 800, 755), c(185, 185, 182.8, 182.8), border = "#c05a50", col = "#c05a50")
polygon(c(800, 755, 800, 755), c(187, 187, 189, 189), border = "#c05a50", col = "#c05a50")
polygon(c(800, 755, 800, 755), c(191, 191, 193, 193), border = "#c05a50", col = "#c05a50")
polygon(c(800, 755, 800, 755), c(195, 195, 197, 197), border = "#c05a50", col = "#c05a50")
...
polygon(c(755, 800, 800, 755), c(415.2, 415.2, 398.6, 398.6), border = "#1f5c87", col = "#1f5c87")
...
text(557.5, 810.7, "12", family = "Main", cex = .75, col = "black", srt = 270)
...
text(642.5, 810.7, "3", family = "Main", cex = .75, col = "black", srt = 270)
...
segments(x0=885, x1=810, y0=828.9, y1=828.9, lwd = 1, lty = "solid")
...
text(1245, 817.1, "4", family = "Main", cex = .75, col = "black", srt = 270)
