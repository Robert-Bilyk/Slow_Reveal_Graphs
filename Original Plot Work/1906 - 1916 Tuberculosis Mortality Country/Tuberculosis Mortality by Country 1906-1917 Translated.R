...
png(here::here("Original Plot Work", "1906 - 1916 Tuberculosis Mortality Country", "Tuberculosis Mortality by Country 1906-1917 Translated.png"),width=1000,height=700)
