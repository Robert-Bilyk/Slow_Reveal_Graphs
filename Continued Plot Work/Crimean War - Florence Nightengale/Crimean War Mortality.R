...
plot1 + plot2 +
  ...
  plot_annotation(title = "DIAGRAM OF THE CAUSES OF MORTALITY",
                  ...
                  theme =   theme(plot.title = element_text(hjust=.5, vjust = -19,size = 26, family = "Lancelot", face = "bold"),
                                  ...
                                  plot.background = element_rect(fill = "#f6ebcd")))
dev.off()
print(picture)
...
image_write(img, path = here::here("Continued Plot Work", "Crimean War - Florence Nightengale", "Crimean War Mortality.png"), format = "png")
